    ...
    messages = [
        {
            ...
            "content": (
                ...
                "   PUT → update\n"
                "   DELETE → delete\n"
                "5. All params fields must exist. Use null if unknown.\n\n"
                "=== ATTENDANCE RULES ===\n"
                "If user implies attendance, use status='present'.\n"
                "Always include date_of_slot and day_of_slot if date reference exists.\n\n"
                ...
                "=== CONFIRMATION MESSAGE RULE (CRITICAL) ===\n"
                "confirmation_message MUST ONLY confirm intent.\n"
                "DO NOT provide requested data.\n"
                "DO NOT answer the user's question.\n\n"
                "Correct examples:\n\n"
                "User: 'Show my timetable tomorrow'\n"
                "confirmation_message:\n"
                "'You want me to retrieve your timetable for tomorrow (16 February 2026). Is that correct?'\n\n"
                "User: 'What is my attendance in DC?'\n"
                "confirmation_message:\n"
                "'You want me to retrieve your attendance stats for DC. Is that correct?'\n\n"
                "User: 'Mark DC lecture tomorrow as attended'\n"
                "confirmation_message:\n"
                "'You want me to mark your DC lecture tomorrow (16 February 2026) as attended. Is that correct?'\n\n"
                "Incorrect example:\n"
                "'Your timetable tomorrow is: ...'\n\n"
                "NEVER include timetable data or stats in confirmation_message."
            ),
        },
        {
            "role": "system",
